...
{
    protected $startTime_LifeTimeTaskInfoTrait = -1.0;
    protected $endTime_LifeTimeTaskInfoTrait = -1.0;
    ...
    {
        $startTime = $this->startTime_LifeTimeTaskInfoTrait;
        $lapTime = $this->endTime_LifeTimeTaskInfoTrait;
        if( $lapTime < 0 )
            $lapTime = microtime(true);
        return ($lapTime - $startTime)*1000;
    }
}
